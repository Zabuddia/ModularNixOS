...
def create_app():
	...
	def handle_large_request(_err):
		flash(
			"Your pasted table is too large for the current request limit. "
			"Try a smaller table or increase MAX_CONTENT_LENGTH/MAX_FORM_MEMORY_SIZE.",
			"error",
		)
		return redirect(request.referrer or url_for("admin.upload"))
