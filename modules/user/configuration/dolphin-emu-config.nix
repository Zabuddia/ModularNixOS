...
{
  # --- Wiimote profile: X360 Controller (SDL) ---
  xdg.configFile."dolphin-emu/Profiles/Wiimote/X360-Controller.ini".text = ''
[Profile]
...
'';
  ...
  # --- Wiimote profile: DSU (AlaniPhone) ---
...
'';
  ...
  # --- Wiimote profile: Keyboard/Mouse (XInput2 pointer) ---
  xdg.configFile."dolphin-emu/Profiles/Wiimote/Keyboard-Mouse.ini".text = ''
[Profile]
